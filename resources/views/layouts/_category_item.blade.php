...
@if(isset($category['children']) && count($category['children']) > 0)
  <li class="dropend">
    <a href="{{ route('products.index', ['category_id' => $category['id']]) }}" class="dropdown-item dropdown-toggle" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">{{ $category['name'] }}</a>
